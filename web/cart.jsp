...
<html class="no-js" lang="en">
                                ...
                                <tbody>
                                    ...
                                    <c:forEach var="o" items="${sessionScope.cart}">
                                        <c:set var="s" value="${s + o.p.priceDiscount * o.quantity}"></c:set>
                                            <tr>
                                                <td class="pro-thumbnail"><a href="single-product.jsp?id=${o.p.productID}"><img src="assets/images/products/${o.p.image1}" alt="Product"></a></td>
                                            <td class="pro-title" style="width: 35%; text-align: left;"><a href="single-product.jsp?id=${o.p.productID}">${o.p.productName}</a></td>
                            ...
                            <div class="col-lg-6 col-12 mb-40 d-flex">
                                <div class="cart-summary">
                                    <div id="total" class="cart-summary-wrap">
                                        ...
                                        <h2>Grand Total <span><fmt:setLocale value = "en_US"/><fmt:formatNumber value="${s}" type="currency"/></span></h2>
                                    </div>
    ...
    <script>
        ...
        function updownQt(st, pid) {
            ...
            $.ajax({
                url: "/Project/updownQuantity?action=update",
