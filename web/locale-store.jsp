<%-- 
    Document   : locale-store
    Created on : Mar 19, 2021, 12:22:19 PM
    Author     : tungn
--%>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-12 mb-70">
                            <div class="single-store">
                                <h3>Plog Electronic Australia</h3>
